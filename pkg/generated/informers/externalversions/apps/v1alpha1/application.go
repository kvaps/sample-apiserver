...
type ApplicationInformer interface {
	...
	Lister() appsv1alpha1.ApplicationLister
}
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisappsv1alpha1.Application{}, f.defaultInformer)
}

func (f *applicationInformer) Lister() appsv1alpha1.ApplicationLister {
	return appsv1alpha1.NewApplicationLister(f.Informer().GetIndexer())
}
