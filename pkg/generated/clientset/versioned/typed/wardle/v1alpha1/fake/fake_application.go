...
func (c *FakeApplications) Apply(ctx context.Context, application *wardlev1alpha1.ApplicationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Application, err error) {
	if application == nil {
...
func (c *FakeApplications) ApplyStatus(ctx context.Context, application *wardlev1alpha1.ApplicationApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Application, err error) {
	if application == nil {
		return nil, fmt.Errorf("application provided to Apply must not be nil")
	}
	data, err := json.Marshal(application)
